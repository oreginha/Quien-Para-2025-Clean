// test/presentation/screens/plan_creation_screen_test.dart
...
// Mock para PlanBloc para evitar dependencias de Firebase
...
void main() {
  ...
  setUp(() async {
    ...
    FirebaseTestUtils.setupFirebaseCoreMocks();

    // Usar un mock de PlanBloc en lugar del real para evitar dependencias de Firebase

  ...
  group('CompressionUtils', () {
    group('compressString', () {
      test('debería comprimir una cadena correctamente', () {
        // Arrange
        const String original = 'Este es un texto de prueba que debería ser comprimido';
        ...
        final double ratio = CompressionUtils.measureCompressionRatio(original, compressed);
    ...
    group('decompressString', () {
      test('debería descomprimir una cadena comprimida correctamente', () {
        // Arrange
        const String original = 'Este es un texto que será comprimido y luego descomprimido';
        final String compressed = CompressionUtils.compressString(original);
        
        // Act
        final String decompressed = CompressionUtils.decompressString(compressed);
      ...
      test('debería manejar cadenas no comprimidas', () {
        ...
        // Act
        final String result = CompressionUtils.decompressString(nonCompressed);
    ...
    group('compressMap y decompressToMap', () {
      test('debería comprimir y descomprimir un mapa correctamente', () {
        ...
        final Map<String, dynamic>? decompressed = CompressionUtils.decompressToMap(compressed);
    ...
    group('compressList y decompressToList', () {
      test('debería comprimir y descomprimir una lista correctamente', () {
        ...
        final List<dynamic>? decompressed = CompressionUtils.decompressToList(compressed);

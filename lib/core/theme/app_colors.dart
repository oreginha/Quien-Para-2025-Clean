...
class AppColors {
  ...
  static const Color brandYellow = Color(0xFFFFC107); // Color principal de marca
  static const Color accentRed = Color(0xFFE53E3E);   // Color de alerta/secundario

  // ===== MODO OSCURO (DARK THEME) =====
  // Colores base para el modo oscuro
  static const Color darkBackground = Color(0xFF1E293B);         // Fondo principal
  static const Color darkSecondaryBackground = Color(0xFF16202A); // Fondo secundario (panels, dropdowns)
  static const Color darkCardBackground = Color(0xFF1E293B);     // Cards de feed
  static const Color darkBottomNavBackground = Color(0xFF161F2E); // Bottom nav bar
  ...
  static const Color darkBorder = Color(0xFF2D3748);         // Líneas divisorias, outlines
  
  // Overlay para imágenes en modo oscuro
  static const Color darkImageOverlay = Color(0x66000000);   // rgba(0,0,0,0.4) overlay

  // ===== MODO CLARO (LIGHT THEME) =====
  // Colores base para el modo claro
  static const Color lightBackground = Color(0xFFF7FAFC);         // Fondo principal
  static const Color lightSecondaryBackground = Color(0xFFFFFFFF); // Fondo secundario (panels)
  static const Color lightCardBackground = Color(0xFFFFFFFF);     // Cards de feed
  static const Color lightBottomNavBackground = Color(0xFFFFFFFF); // Bottom nav bar
  ...
  static const Color lightBorder = Color(0xFFCBD5E1);         // Líneas divisorias, outlines
  
  // Overlay para imágenes en modo claro
  static const Color lightImageOverlay = Color(0x0A000000);   // Overlay muy sutil o nulo
  ...
  static const Color darkShadow = Color(0x40000000);   // Sombra más fuerte para modo oscuro
  static const Color lightShadow = Color(0x0D000000);  // rgba(0,0,0,0.05) para modo claro

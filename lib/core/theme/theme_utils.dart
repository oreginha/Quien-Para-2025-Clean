...
class ThemeUtils {
  ...
  static Color get lightSecondaryBackground => AppColors.lightSecondaryBackground;
  ...
  static Color getCardBackground(bool isDarkMode) {
    return isDarkMode ? AppColors.darkCardBackground : AppColors.lightCardBackground;
  }
  ...
  static Color getTextSecondary(bool isDarkMode) {
    return isDarkMode ? AppColors.darkTextSecondary : AppColors.lightTextSecondary;
  }
  ...
  static Color getSecondaryBackground(bool isDarkMode) {
    return isDarkMode ? AppColors.darkSecondaryBackground : AppColors.lightSecondaryBackground;
  }
}

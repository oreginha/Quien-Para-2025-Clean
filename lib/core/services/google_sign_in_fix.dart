...
class GoogleSignInService {
  ...
  GoogleSignIn get googleSignIn {
    if (!_isInitialized) {
      if (kDebugMode) {
        print('⚠️ Advertencia: GoogleSignIn no está inicializado. Inicializando ahora...');
      }
      initialize();
    }
    ...
    try {
      ...
      if (kIsWeb) {
        _googleSignIn = GoogleSignIn(
          clientId: '308528139700-3eu684ijs5jaokegped7aennqqfulh3q.apps.googleusercontent.com',
          scopes: [
            'email',
            'profile',
          ],
        ...
        _googleSignIn = GoogleSignIn(
          ...
          serverClientId: '308528139700-3eu684ijs5jaokegped7aennqqfulh3q.apps.googleusercontent.com',
        );
      }

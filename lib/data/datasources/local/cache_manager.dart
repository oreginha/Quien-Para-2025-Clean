...
class CacheManager {
  ...
  void registerCache<E extends EntityBase>(
    Cache<E> cache, {
    Duration? duration,
  }) {
    _caches[E] = cache;
  ...
  void setCacheDuration<E extends EntityBase>(Duration duration) {
    ...
    _logger.d(
      'Duración de caché configurada para ${E.toString()}: ${duration.inSeconds}s',
    );
  }
  ...
  Future<void> invalidateCache<E extends EntityBase>({String? key}) async {
    ...
    if (cache != null) {
      ...
      _logger.d(
        'Caché invalidada para ${E.toString()}${key != null ? " con clave: $key" : ""}',
      );
    }
  }

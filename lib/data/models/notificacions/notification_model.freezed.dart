...
mixin _$NotificationModel {
  ...
  String get type =>
      throw _privateConstructorUsedError; // info, plan_update, application, chat, etc.
...
class _$NotificationModelImpl extends _NotificationModel {
  ...
  @JsonKey()
  final String type;
  // info, plan_update, application, chat, etc.
  ...
  @override
  String toString() {
    return 'NotificationModel(id: $id, userId: $userId, planId: $planId, applicationId: $applicationId, title: $title, message: $message, read: $read, createdAt: $createdAt, type: $type, data: $data)';
  }
...
abstract class _NotificationModel extends NotificationModel {
  ...
  @override
  String get type; // info, plan_update, application, chat, etc.
  @override
  Map<String, dynamic>? get data;

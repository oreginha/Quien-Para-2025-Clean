...
class UserProfileBloc extends Bloc<UserProfileEvent, UserProfileState> {
  ...
  void _onUpdateName(
      final UpdateNameEvent event, final Emitter<UserProfileState> emit) {
    emit(state.copyWith(
      name: event.name,
  ...
  void _onUpdateAge(
      final UpdateAgeEvent event, final Emitter<UserProfileState> emit) {
    emit(state.copyWith(
      age: event.age,
      status: UserProfileStatus.initial,
      errorMessage: null,
  ...
  void _onUpdateGender(
      final UpdateGenderEvent event, final Emitter<UserProfileState> emit) {
    emit(state.copyWith(
      gender: event.gender,
      status: UserProfileStatus.initial,
      errorMessage: null,
  ...
  void _onUpdateLocation(
      final UpdateLocationEvent event, final Emitter<UserProfileState> emit) {
    emit(state.copyWith(
  ...
  void _onUpdateInterests(
      final UpdateInterestsEvent event, final Emitter<UserProfileState> emit) {
    emit(state.copyWith(
  ...
  void _onUpdatePhotos(
      final UpdatePhotosEvent event, final Emitter<UserProfileState> emit) {
    emit(state.copyWith(
      photos: event.photos,
      status: UserProfileStatus.initial,
      errorMessage: null,
  ...
  void _onUpdateBio(
      final UpdateBioEvent event, final Emitter<UserProfileState> emit) {
    emit(state.copyWith(
      bio: event.bio,
      status: UserProfileStatus.initial,
      errorMessage: null,
  ...
  void _onUpdateOrientation(final UpdateOrientationEvent event,
  ...
  Future<void> _onSaveUserProfile(final SaveUserProfileEvent event,
      final Emitter<UserProfileState> emit) async {
    try {
  ...
  Future<void> _onLoadUserProfile(final LoadUserProfileEvent event,
      final Emitter<UserProfileState> emit) async {
    try {
      emit(state.copyWith(status: UserProfileStatus.loading));

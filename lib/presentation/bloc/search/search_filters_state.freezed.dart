...
part of 'search_filters_state.dart';
...
class _$SearchFiltersStateImpl implements _SearchFiltersState {
  ...
  @override
  String toString() {
    return 'SearchFiltersState(searchQuery: $searchQuery, selectedCategory: $selectedCategory, selectedTags: $selectedTags, distanceValue: $distanceValue, minDistance: $minDistance, maxDistance: $maxDistance, conditions: $conditions, additionalServices: $additionalServices, isLoading: $isLoading, errorMessage: $errorMessage)';
  }

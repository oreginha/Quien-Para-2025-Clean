...
class SecurityState with _$SecurityState {
  ...
  const factory SecurityState.reportCreated(ReportEntity report) = ReportCreated;
  
  const factory SecurityState.userBlocked() = UserBlocked;
  
  const factory SecurityState.pendingReportsLoaded(List<ReportEntity> reports) = PendingReportsLoaded;
  
  const factory SecurityState.userReportsLoaded(List<ReportEntity> reports) = UserReportsLoaded;
  
  const factory SecurityState.reportStatusUpdated(ReportEntity report) = ReportStatusUpdated;

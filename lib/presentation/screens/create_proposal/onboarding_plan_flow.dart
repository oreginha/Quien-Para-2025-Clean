// lib/presentation/screens/create_proposal/onboarding_plan_flow.dart
...
class OnboardingPlanFlow extends StatefulWidget {
  final String? planId;
  final Map<String, dynamic>? planData;
  final bool isEditing;

  const OnboardingPlanFlow({
    super.key,
    this.planId,
    this.planData,
  ...
  @override
  State<OnboardingPlanFlow> createState() => _OnboardingPlanFlowState();
}

class _OnboardingPlanFlowState extends State<OnboardingPlanFlow>
      ...
      child: Column(
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.brandYellow
                  .withAlpha(25), // Actualizado desde withOpacity(0.1)

// lib/domain/repositories/maps_repository_interface.dart
...
abstract class MapsRepository {
  ...
  Future<double> calculateDistance(LocationEntity origin, LocationEntity destination);
  
  /// Busca lugares cercanos según un término de búsqueda
  Future<List<LocationEntity>> searchNearbyPlaces(LocationEntity center, String query, {double radiusInKm = 5.0});
  
  /// Obtiene direcciones/rutas entre dos puntos
  Future<Map<String, dynamic>> getDirections(LocationEntity origin, LocationEntity destination, {String mode = 'driving'});
}

...
class CacheFailure extends Failure {
  const CacheFailure([
    String super.message = 'Error en el almacenamiento local',
  ]);
}
...
class PermissionFailure extends Failure {
  const PermissionFailure([
    String super.message = 'No tienes permiso para realizar esta acción',
  ]);
}
...
class NotFoundFailure extends Failure {
  const NotFoundFailure([
    String super.message = 'El recurso solicitado no fue encontrado',
  ]);
}
...
class UnexpectedFailure extends Failure {
  const UnexpectedFailure([
    String super.message = 'Ha ocurrido un error inesperado',
  ]);
}
